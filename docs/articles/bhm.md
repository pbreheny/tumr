...
```
    ...
    1 A          3.65  3.27  4.04     38.6   26.4    56.6
    2 B          4.20  3.81  4.59     66.6   45.4    98.1
    3 C          4.44  4.05  4.82     84.8   57.5   125.
    4 D          4.99  4.60  5.38    147.    99.1   216.
    5 E          3.52  3.10  3.92     33.6   22.3    50.5

    $slope_each
    # A tibble: 5 × 10
      treatment   mean     q5    q95 growth_factor_mean growth_factor_q5
      <chr>      <dbl>  <dbl>  <dbl>              <dbl>            <dbl>
    1 A         0.0801 0.0651 0.0953               1.08             1.07
    2 B         0.0401 0.0244 0.0559               1.04             1.02
    3 C         0.0531 0.0380 0.0678               1.05             1.04
    4 D         0.0551 0.0388 0.0714               1.06             1.04
    5 E         0.0488 0.0327 0.0648               1.05             1.03
    ...
    # A tibble: 10 × 10
       ...
       <chr>       <dbl>    <dbl>   <dbl>      <dbl>    <dbl>     <dbl>
     1 A - B     0.0400   0.0175  0.0620       1.04     1.02       1.06
     2 A - C     0.0270   0.00570 0.0483       1.03     1.01       1.05
     3 A - D     0.0250   0.00261 0.0476       1.03     1.00       1.05
     4 A - E     0.0314   0.00946 0.0534       1.03     1.01       1.05
     5 B - C    -0.0129  -0.0343  0.00904      0.987    0.966      1.01
     6 B - D    -0.0150  -0.0368  0.00760      0.985    0.964      1.01
     7 B - E    -0.00861 -0.0310  0.0132       0.991    0.970      1.01
     8 C - D    -0.00205 -0.0245  0.0200       0.998    0.976      1.02
     9 C - E     0.00431 -0.0174  0.0261       1.00     0.983      1.03
    10 D - E     0.00636 -0.0164  0.0291       1.01     0.984      1.03
