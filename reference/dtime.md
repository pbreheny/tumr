...
#> Chain 1 Exception: lkj_corr_cholesky_lpdf: Random variable[2] is 0, but must be positive! (in '/tmp/RtmpkGUOS2/model-1e4e4fab65be.stan', line 52, column 2 to column 32)
...
#> Chain 2 Exception: lkj_corr_cholesky_lpdf: Random variable[2] is 0, but must be positive! (in '/tmp/RtmpkGUOS2/model-1e4e4fab65be.stan', line 52, column 2 to column 32)
...
#> Chain 3 Exception: lkj_corr_cholesky_lpdf: Random variable[2] is 0, but must be positive! (in '/tmp/RtmpkGUOS2/model-1e4e4fab65be.stan', line 52, column 2 to column 32)
...
#> Chain 4 Exception: lkj_corr_cholesky_lpdf: Random variable[2] is 0, but must be positive! (in '/tmp/RtmpkGUOS2/model-1e4e4fab65be.stan', line 52, column 2 to column 32)
...
#> Chain 2 finished in 49.4 seconds.
#> 
#> All 4 chains finished successfully.
#> Mean chain execution time: 47.3 seconds.
#> Total execution time: 49.5 seconds.
#> 
dtime(fit1)
#> $method
