...
#> Chain 1 Exception: lkj_corr_cholesky_lpdf: Random variable[2] is 0, but must be positive! (in '/tmp/RtmpUcsv4X/model-1e69763090e5.stan', line 52, column 2 to column 32)
...
#> Chain 2 Exception: lkj_corr_cholesky_lpdf: Random variable[2] is 0, but must be positive! (in '/tmp/RtmpUcsv4X/model-1e69763090e5.stan', line 52, column 2 to column 32)
...
#> Chain 3 Exception: lkj_corr_cholesky_lpdf: Random variable[2] is 0, but must be positive! (in '/tmp/RtmpUcsv4X/model-1e69763090e5.stan', line 52, column 2 to column 32)
...
#> Chain 4 Exception: lkj_corr_cholesky_lpdf: Random variable[2] is 0, but must be positive! (in '/tmp/RtmpUcsv4X/model-1e69763090e5.stan', line 52, column 2 to column 32)
...
#> Chain 4 finished in 45.4 seconds.
