...
#> Chain 1 Exception: lkj_corr_cholesky_lpdf: Random variable[2] is 0, but must be positive! (in '/tmp/Rtmp5mm2FY/model-1e774e4bd01c.stan', line 52, column 2 to column 32)
...
#> Chain 2 Exception: lkj_corr_cholesky_lpdf: Random variable[2] is 0, but must be positive! (in '/tmp/Rtmp5mm2FY/model-1e774e4bd01c.stan', line 52, column 2 to column 32)
...
#> Chain 3 Exception: lkj_corr_cholesky_lpdf: Random variable[2] is 0, but must be positive! (in '/tmp/Rtmp5mm2FY/model-1e774e4bd01c.stan', line 52, column 2 to column 32)
...
#> Chain 4 Exception: lkj_corr_cholesky_lpdf: Random variable[2] is 0, but must be positive! (in '/tmp/Rtmp5mm2FY/model-1e774e4bd01c.stan', line 52, column 2 to column 32)
...
#> Chain 4 finished in 47.7 seconds.
...
#> Total execution time: 49.9 seconds.
#> 
dtime(fit1)
#> $method
