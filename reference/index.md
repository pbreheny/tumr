...
- [`bhm()`](https://pbreheny.github.io/tumr/reference/bhm.md) :
  ...
  Bayesian hierarchical model for tumor growth Fits a Bayesian
  hierarchical linear model to longitudinal tumor volume data on the
  `log1p(Volume)` scale, allowing treatment-specific population
  intercepts and slopes and subject-specific random intercept/slope.
...
- [`melanoma2`](https://pbreheny.github.io/tumr/reference/melanoma2.md)
...
- [`tumr_power()`](https://pbreheny.github.io/tumr/reference/tumr_power.md)
