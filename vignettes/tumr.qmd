...
plot(lmm_mel2, "response") + scale_y_log10()
plot(lmm_mel2, "slope")
```
...
In addition to the linear mixed model, the package also supports fitting a Bayesian hierarchical linear model. Detailed usage of this model is described in an article.
